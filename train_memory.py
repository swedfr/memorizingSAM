...
parser.add_argument('--task_name', type=str, default='FastSAM3D')
parser.add_argument('--click_type', type=str, default='random')
parser.add_argument('--multi_click', action='store_true', default=False)
parser.add_argument('--model_type', type=str, default='vit_b_ori') #use bori model type if need diffferent model
parser.add_argument('--checkpoint', type=str, default='/content/drive/MyDrive/lighting_sam_3d/ckpt/sam_med3d_turbo.pth')  # turbo model
parser.add_argument('--device', type=str, default='cuda')
parser.add_argument('-dir','--work_dir', type=str, default='./wordallSAMMed3D') # output finetune checkpoint
...
def build_model(args):
    ...
    checkpoint_path = '/content/drive/MyDrive/lighting_sam_3d/vertebraall/sam_model_latest.pth'
...
def get_dataloaders(args):
    d = []
    d.append(args.datapath)
    train_dataset = Dataset_Union_ALL(paths=d, transform=tio.Compose([
        tio.ToCanonical(),
    ...
    def train_epoch(self, epoch, num_clicks):
        ...
        for step, (image3D, gt3D) in enumerate(tbar):
            ...
            with my_context():
                ...
                with amp.autocast():
                    image_embedding,t = sam_model.image_encoder(image3D)
